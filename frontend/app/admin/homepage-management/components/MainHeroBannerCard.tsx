...
export default function MainHeroBannerCard({
  banners,
  onAddBanner,
  onUpdateBanner,
  onDeleteBanner,
}: MainHeroBannerCardProps) {
  const fileInputRefs =
    useRef<
      Record<
        string,
  ...
  return (
    <article className="overflow-hidden rounded-2xl border border-gray-200 bg-gray-50/70">
      ...
      <div className="flex min-h-[106px] flex-col gap-4 border-b border-gray-200 bg-white p-4 sm:p-5 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-1 max-w-[420px] text-xs leading-5 text-gray-500">
              ...
              carousel banners and add more
              banner positions whenever
              needed.
            </p>
          </div>
        </div>

        <div className="flex shrink-0 flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center xl:justify-end">
          ...
          <button
            ...
            className="inline-flex min-h-10 w-full items-center justify-center gap-2 rounded-lg bg-[#0B1F3A] px-3 py-2 text-xs font-bold text-white transition-colors hover:bg-[#132f52] disabled:cursor-not-allowed disabled:opacity-60 sm:w-auto"
          >
            <Plus
              size={15}
              aria-hidden="true"
        ...
        {banners.length > 0 ? (
                    ...
                    editingBanner && (
                      <div className="mt-4 border-t border-gray-100 pt-4">
                        <div className="grid gap-4 sm:grid-cols-2">
                          ...
                          <div className="sm:col-span-2">
                            ...
                            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_260px]">
                              ...
                              <div>
                                ...
                                <div className="relative aspect-[1080/550] overflow-hidden rounded-xl border border-dashed border-gray-300 bg-gray-50">
                                  {cleanEditingImage ? (
                                    <>
                                      <Image
                                        src={
                          ...
                          <div className="sm:col-span-2">
                            <label className="flex min-h-11 cursor-pointer items-center justify-between gap-4 rounded-lg border border-gray-200 bg-gray-50 px-4">
                              <div>
          ...
          <div className="flex min-h-32 flex-col items-center justify-center rounded-xl border border-dashed border-gray-300 bg-white px-4 py-8 text-center">
            ...
            <p className="mt-3 text-sm font-bold text-gray-500">
              No main banners added yet
            </p>

            <p className="mt-1 text-xs leading-5 text-gray-400">
              Use the add button to create
              a new main hero banner.
            </p>
          </div>
        )}
      </div>
